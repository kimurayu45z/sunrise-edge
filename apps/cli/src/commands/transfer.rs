...
//! `docs/architecture/README.md` §44 / DR-0083); this file only uses the small, generic
...
//! (see `docs/architecture/README.md` DR-0085 / `TODO.md` CLI-First Node Production Gate
...
//! alongside the server's committed module policy (see `docs/architecture/README.md`
...
/// entrypoint name (see `docs/architecture/README.md` §"Local devnet architecture").
...
/// [`ExpectedProtocolContext`] (see `docs/architecture/README.md` DR-0085), rejecting a
...
/// `docs/architecture/README.md` DR-0086). Checking here too only saves a round trip and
