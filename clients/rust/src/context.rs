...
//! boundary (`docs/architecture/decisions/0081-0087-cli-first-roadmap.md` DR-0085; `TODO.md` CLI-First Node Production
//! Gate S1a).
//!
...
/// documented in `docs/architecture/core-protocol.md` §8/§11 (chain id, protocol version,
